...
colors[1]="yelllow"
print(colors[::-1]) # ['blue', 'yelllow', 'red']
...
for key in fruit_stock:
    print(key, "의 재고는", fruit_stock[key], "개 입니다.")

# apple 의 재고는 10 개 입니다.
# banana 의 재고는 5 개 입니다.
# cherry 의 재고는 15 개 입니다.
