...
input_width=int(input("밑변 입력> "))
input_height=int(input("높이 입력> "))
print(get_triangle_area(input_width, input_height))
...
def calculate_payment(price, count, discount=0.1):
    return f"최종 결제 금액 = {price*count*(1-discount)}"
input_price=int(input("상품 가격> "))
input_count=int(input("수량> "))
print(calculate_payment(input_price, input_count))